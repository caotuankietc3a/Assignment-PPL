...
public class io {
   ...
   */
  public static void putInt(int i) { System.out.print(i + ""); }

  /**
   *same as putInt except that it also prints a newline
   *	@param i the value is printed out
   */
  public static void putIntLn(int i) { System.out.println(i + ""); }
   ...
   */
  public static void putFloat(float f) { System.out.print(f + ""); }

  /**
   *same as putFloat except that it also prints a newline
   *	@param f the floating-point value is printed out
   */
  public static void putFloatLn(float f) { System.out.println(f + ""); }
   ...
   */
  public static void putBool(boolean b) { System.out.print(b + ""); }

  /**
   *same as putBoolLn except that it also prints a new line
   *	@param b the boolean value is printed out
   */
  public static void putBoolLn(boolean b) { System.out.println(b + ""); }
  /**
   * reads and returns a boolean value from the standard input
   *  @return int a boolean value read from standard input
   */
   ...
   */
  public static void putString(String a) { System.out.print(a); }

  /**
   *same as putString except that it also prints a new line
   *	@param a the string is printed out
   */
  public static void putStringLn(String a) { System.out.println(a); }
  /**
   *print out an empty line
   **/
  public static void putLn() { System.out.println(); }
